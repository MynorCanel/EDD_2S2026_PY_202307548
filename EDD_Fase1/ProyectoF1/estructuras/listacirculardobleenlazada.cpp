...
#include <fstream>
#include <string>
#include "../modelos/NodoSolicitud.cpp"
...
public:
    ...
    void insertar(string nombreCliente, string telefonoContacto, string tipoSolicitud, string descripcion, string fechaSolicitud, string estadoSolicitud) {
        NodoSolicitud* nuevo = new NodoSolicitud(new Solicitud(numSolicitud, nombreCliente, telefonoContacto, tipoSolicitud, descripcion, fechaSolicitud, estadoSolicitud));
        numSolicitud++; // Incrementa el número de solicitud para la próxima inserción
        if (cabeza == nullptr) {
    ...
    void eliminar(string nombre) {
        ...
        do {
            if (actual->solicitud->nombreCliente == nombre) {
                ...
                cout << "Solicitud " << actual->solicitud->numeroSolicitud << " eliminada." << endl;
                delete actual;
                return;
            }
    ...
    void graficar() {
        ...
        do {
            archivo << "    nodo" << i << " [label=\"{"
                    << actual->solicitud->numeroSolicitud << " | "
                    ...
                    << actual->solicitud->estadoSolicitud << " | "
                    << "}\"];" << endl;
            actual = actual->siguiente;
            i++;
        } while (actual != cabeza);
    ...
    void mostrar() {
        ...
        NodoSolicitud* actual = cabeza;
        do {
            cout << actual->solicitud->numeroSolicitud << ", " << actual->solicitud->nombreCliente << ", " << actual->solicitud->telefonoContacto << ", " << actual->solicitud->tipoSolicitud << ", " << actual->solicitud->descripcion << ", " << actual->solicitud->fechaSolicitud << ", " << actual->solicitud->estadoSolicitud << endl;
    ...
    ~ListaCircularDoble() {
        ...
        do {
            temp = actual;
            actual = actual->siguiente;
            delete temp->solicitud; // liberar memoria de la solicitud
            delete temp;
        } while (actual != cabeza);
    }
};